...
function getUserFromCookie(): { userId: string; role: string; name: string } | null {
    try {
          const cookies = document.cookie.split(';').map(c => c.trim());
          const tokenCookie = cookies.find(c => c.startsWith('auth-token-js=')) || cookies.find(c => c.startsWith('auth-token='));
