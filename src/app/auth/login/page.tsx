...
function LoginContent() {
  ...
  useEffect(() => {
    ...
    const webviewPatterns = [
      /KAKAOTALK/i, /NAVER/i, /Line/i, /Instagram/i, /FB_IAB/i, /FBAN/i,
      /Twitter/i, /wv\)/i, /WebView/i, /\bSamsungBrowser\/\d/i
    ];
    const isWV = webviewPatterns.some(p => p.test(ua)) ||
